	...
	<div style="border: 1px solid f8f9fa;" class=""border">
		<div class="left-sidebar">
			...
			<div class="hclass-section">
				...
				<ul class="hclass-list">
					<li class="hclass-item">
						<div class="avatar avatar-red" id="profile-item">김</div> <span
						class="member-name">김시연</span>
					</li>
					<li class="hclass-item">
						<div class="avatar avatar-purple">동</div> <span
						class="member-name">동진이 형</span>
					</li>
					<li class="hclass-item">
						<div class="avatar avatar-purple">고</div> <span
						class="member-name">고조장</span>
					</li>
					<li class="hclass-item">
						<div class="avatar avatar-purple">용</div> <span
						class="member-name">용훈 형님</span>
					</li>
					<li class="hclass-item">
						<div class="avatar avatar-orange">전</div> <span
						class="member-name">전창용</span>
					</li>
					<li class="hclass-item">
						<div class="avatar avatar-orange">김</div> <span
						class="member-name">김준서</span>
					</li>
				</ul>
			</div>
			...
			<div class="class-dropdown">
				<span>A - Class</span> <span class="dropdown-arrow">▼</span>
			</div>

			<div class="class-dropdown">
				<span>B - Class</span> <span class="dropdown-arrow">▼</span>
			</div>

			<div class="class-dropdown">
				<span>C - Class</span> <span class="dropdown-arrow">▼</span>
			</div>

			<div class="class-dropdown">
				<span>D - Class</span> <span class="dropdown-arrow">▼</span>
			</div>

			<div class="class-dropdown">
				<span>E - Class</span> <span class="dropdown-arrow">▼</span>
			</div>

			<div class="class-dropdown">
				<span>F - Class</span> <span class="dropdown-arrow">▼</span>
			</div>

			<div class="class-dropdown">
				<span>G - Class</span> <span class="dropdown-arrow">▼</span>
			</div>

			<div class="class-dropdown">
				<span>I - Class</span> <span class="dropdown-arrow">▼</span>
			</div>

			<div class="class-dropdown">
				<span>J - Class</span> <span class="dropdown-arrow">▼</span>
			</div>

			<div class="class-dropdown">
				<span>K - Class</span> <span class="dropdown-arrow">▼</span>
			</div>
		</div>
